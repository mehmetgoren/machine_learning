...
#conv2d
def conv2d(x,W):
    #x --> [batrch, H,W,Channles]. channels->rgb
    #W --> [filter H, filter W, Channles IN, Channles OUT]
...
convo_2_flat = tf.reshape(convo_1_pooling, [-1,7*7*64])
